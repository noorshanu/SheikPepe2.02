    ...
    <section className=" pt-0  relative ">
      <div className="container-wrapper">
        ...
        <div className=" flex justify-center gap-4 items-center py-4">
          <a
            href="https://www.dextools.io/app/en/solana/pair-explorer/Adtpbv9nXKGbPgbmWy3Xkm11giF85apiqoT7FJr6GSiJ?t=1715071815787" target="_blank"
        ...
        <a
          href="https://solscan.io/token/DZ9fuFqkrwdDdM3va5T51yZ67SG4iNV3hda5aAFB4xVg"
          target="_blank"
          className=" flex justify-center font-groot-two text-xs sm:text-xl text-center my-3 text-white "
        >
          CONTRACT: DZ9fuFqkrwdDdM3va5T51yZ67SG4iNV3hda5aAFB4xVg
        </a>
      </div>
    </section>
  );
